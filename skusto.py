...
from azure.kusto.data.response import KustoResponseDataSet, KustoResponseDataSetV2, KustoResponseDataSetV1
...
class KustoClient(_KustoClientBase):
    ...
    def execute_query(self, database: str, query: str, properties: ClientRequestProperties = None) -> KustoResponseDataSet:
        ...
        :rtype: azure.kusto.data.response.KustoResponseDataSet
        """
        return self.s_execute(self._query_endpoint, database, query, None, self._query_default_timeout, properties)
